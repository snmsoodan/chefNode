...
Gem::Specification.new do |s|
  ...
  s.files = ["CONTRIBUTING.md".freeze, "LICENSE".freeze, "README.md".freeze, "bin/chef-apply".freeze, "bin/chef-client".freeze, "bin/chef-resource-inspector".freeze, "bin/chef-shell".freeze, "bin/chef-solo".freeze, "bin/knife".freeze]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<chef-config>.freeze, ["= 14.2.0"])
      s.add_runtime_dependency(%q<mixlib-cli>.freeze, ["~> 1.7"])
      s.add_runtime_dependency(%q<mixlib-log>.freeze, [">= 2.0.3", "~> 2.0"])
      ...
      s.add_runtime_dependency(%q<ffi>.freeze, [">= 1.9.25", "~> 1.9"])
      ...
      s.add_dependency(%q<chef-config>.freeze, ["= 14.2.0"])
      s.add_dependency(%q<mixlib-cli>.freeze, ["~> 1.7"])
      s.add_dependency(%q<mixlib-log>.freeze, [">= 2.0.3", "~> 2.0"])
      ...
      s.add_dependency(%q<ffi>.freeze, [">= 1.9.25", "~> 1.9"])
